...
DATASET = 'KITTI_Vision'  # ['KITTI_Vision', 'Pascal_VOC']
...
if __name__ == "__main__":
    ...
    if DATASET == 'Pascal_VOC':
        ...
        voc2012_train = KITTI_Vision('/Vault_4/HiWi_IGD/KITTY_Vision/', IMG_WIDTH, IMG_HEIGHT)
        voc2012_val = KITTI_Vision('/Vault_4/HiWi_IGD/KITTY_Vision/', IMG_WIDTH, IMG_HEIGHT)
    ...
    # yolo_model = nn.DataParallel(yolo_model, device_ids=[1])  # TODO
